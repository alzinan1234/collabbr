...
import { Star, Eye, Reply, X, Edit2, ChevronDown, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function Reviews() {
  ...
  const handleUpdateReply = () => {
    setReviews(prev => prev.map(r => 
      ...
      ? { ...r, reply: replyText, status: "Replied" } 
      : r
    ));
                ...
                >
                  <button
                    onClick={() => {
                      ...
                      setOpenRatingDropdown(false);                      handleFilterChange();                    }}
            ...
            >
              <div className="p-8">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700">You reply</label>
                  <textarea 
                    value={replyText}
